...
# based on swbd's local/chain/run_tdnn_6z_discriminative.sh script
# Assumes you already ran local/chain/run_tdnn_7b.sh
...
srcdir=exp/chain/tdnn_7b
train_data_dir=data/train_rvb_hires
online_ivector_dir=exp/nnet3/ivectors_train
