...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/cwrnn_swb3  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/cwrnn_swb3_ld5_sp/egs
...
if [ $stage -le 12 ]; then
  ...
  steps/nnet3/cwrnn/make_configs.py  \
    ...
    --num-cwrnn-layers 3 \
    --ratewise-params "{'T1': {'rate':1.0/3, 'dim':512},
