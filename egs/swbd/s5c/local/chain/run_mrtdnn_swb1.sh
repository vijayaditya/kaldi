...
# discontinued as this is too slow. I changed the AddMultiRateTdnnLayer method
# to create a more efficient architecture
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/mrtdnn_swb1  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
remove_egs=false
common_egs_dir=exp/chain/mrtdnn_swb1_sp/egs/
xent_regularize=0.1
...
if [ $stage -le 12 ]; then
  ...
  steps/nnet3/mrtdnn/make_configs.py \
    ...
    --tree-dir $treedir \
    --ratewise-params "{'T1': {'rate':1.0/3, 'dim':256},
                        'T2': {'rate':1.0/6, 'dim':256},
                        'T3': {'rate':1.0/9, 'dim':256}}" \
    --self-repair-scale-nonlinearity 0.00001 \
    --operating-time-period 3 \
    --projection-dim 512 \
    --relu-dim 512 \
    --splice-indexes "-1,0,1 -3,0,3 -3,0,3 -3,0,3 -6,-3,0 0 0" \
