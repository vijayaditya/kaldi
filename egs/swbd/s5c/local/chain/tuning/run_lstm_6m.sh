...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/lstm_6m  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/blstm_6i_sp/egs
...
if [ $stage -le 12 ]; then
  ...
  steps/nnet3/lstm/make_configs_tdnn.py  \
    --feat-dir data/${train_set}_hires \
    --ivector-dir exp/nnet3/ivectors_${train_set} \
    --tree-dir $treedir \
    --splice-indexes="-2,-1,0,1,2 0,3 0,3 0,3 0,3 0,3 0" \
    --lstm-delay=" -3 -3 -3 " \
