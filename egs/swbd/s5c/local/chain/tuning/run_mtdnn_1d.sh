...
# same as 1a but with input window -+time-period/2
# change made in the xconfig mtdnn class so this script does not change
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/mtdnn_1d  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
lattice_beam=
...
if [ $stage -le 12 ]; then
  ...
  mtdnnl-layer name=mtdnn1 splice-indexes=-3,0,3 rate-dims=625,325,325 dim=625
  mtdnnl-layer name=mtdnn2 splice-indexes=-3,0,3 rate-dims=625,325,325 dim=625
  mtdnnl-layer name=mtdnn3 splice-indexes=-3,0,3 rate-dims=625,325,325 dim=625
  mtdnnl-layer name=mtdnn4 splice-indexes=-3,0,3 rate-dims=625,325,325 dim=625
