...
if [ $stage -le 12 ]; then
  ...
  mtdnn-layer name=mtdnn1 splice-indexes=-3,0,3 rate-dims=625,325,325 dim=625 slow-rate-optional=true
  mtdnn-layer name=mtdnn2 splice-indexes=-3,0,3 rate-dims=625,325,325 dim=625 slow-rate-optional=true
  mtdnn-layer name=mtdnn3 splice-indexes=-3,0,3 rate-dims=625,325,325 dim=625 slow-rate-optional=true
  mtdnn-layer name=mtdnn4 splice-indexes=-3,0,3 rate-dims=625,325,325 dim=625 slow-rate-optional=true
