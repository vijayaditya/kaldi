...
# same as mrtdnn_swb1, but with no PDA before operating period
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/mrtdnn_swb2  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
remove_egs=false
common_egs_dir=exp/chain/mrtdnn_swb2_sp/egs
xent_regularize=0.1
