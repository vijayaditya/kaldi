...
# same as tdnn_6z script but with left and right tolerance of 20 (previously 5)
# very bad
...
dir=exp/$mic/chain/tdnn_ami2${affix:+_$affix} # Note: _sp will get added to this if $speed_perturb == true.
dir=${dir}$suffix
...
if [ $stage -le 14 ]; then
 ...
 steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --chain.left-tolerance 20 \
    --chain.right-tolerance 20 \
