...
class UpdatableComponent: public Component {
 public:
  ...
  UpdatableComponent(BaseFloat learning_rate, bool is_updatable) {
    Init(learning_rate, false, is_updatable);
  }
  ...
  UpdatableComponent(): learning_rate_(0.001), is_updatable_(false) { }
